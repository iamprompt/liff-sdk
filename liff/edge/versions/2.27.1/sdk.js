                    ...
                    i = 0; i < u[s]; ) {
                        ...
                        r = 0; r < 64; r++) {
                            var b = m[r - 15]
                              ...
                              , y = f[0]
                              , I = f[4]
                              , S = f[7] + (n(I, 6) ^ n(I, 11) ^ n(I, 25)) + (I & f[5] ^ ~I & f[6]) + d[r] + (m[r] = r < 16 ? m[r] : m[r - 16] + (n(b, 7) ^ n(b, 18) ^ b >>> 3) + m[r - 7] + (n(g, 17) ^ n(g, 19) ^ g >>> 10) | 0);
    ...
    return ( () => {
        ...
        function b() {
            ...
            this._initBody = function(e) {
                ...
                this._bodyInit = e,
                e ? "string" == typeof e ? this._bodyText = e : o && Blob.prototype.isPrototypeOf(e) ? this._bodyBlob = e : a && FormData.prototype.isPrototypeOf(e) ? this._bodyFormData = e : t && URLSearchParams.prototype.isPrototypeOf(e) ? this._bodyText = e.toString() : s && o && ((n = e) && DataView.prototype.isPrototypeOf(n)) ? (this._bodyArrayBuffer = w(e.buffer),
                this._bodyInit = new Blob([this._bodyArrayBuffer])) : s && (ArrayBuffer.prototype.isPrototypeOf(e) || u(e)) ? this._bodyArrayBuffer = w(e) : this._bodyText = e = Object.prototype.toString.call(e) : this._bodyText = "",
        ...
        var kt = function() {
          ...
          , Lt = {
            ...
            multipleLiffTransition: function() {
                var e = Pt("multipleLiffTransition");
        ...
        var Nt = function() {
          ...
          , Rt = function() {
            function e(t) {
                ve("2.27.1", e.SDK_VERSION_SUPPORTING_NEW) >= 0 ? this.impl = new Nt : this.impl = new Ut(t)
            }
        ...
        function Xt(e) {
            return Kt("".concat($t("accessTokenVerify"), "?access_token=").concat(encodeURIComponent(e)), {
                headers: {
                    "Content-Type": "application/json",
                    Accept: "application/json"
                }
                ...
                return k(t, void 0, void 0, (function() {
                    ...
                    return A(this, (function(a) {
                        ...
                        case 1:
                            ...
                            n.src = "about:blank",
                            document.body.appendChild(n),
                            null === (i = null == n ? void 0 : n.contentWindow) || void 0 === i || i.window.eval("(".concat(ln.toString().replace("$MESSAGE_HANDLER_URL", "".concat("https://liff-subwindow.line.me/liff/v2/sub/messageHandler")).replace("$IDENTIFIER", e.split("'")[0]), ")()")),
            ...
            this.proxyToListeners = function(e) {
                return k(t, void 0, void 0, (function() {
                    ...
                    return A(this, (function(r) {
                        ...
                        "https://liff-subwindow.line.me" !== e.origin ? [2] : t ? (this.sentMessages.includes(cn(t)) || t.identifier !== this.identification.identifier || t.action !== en && !t.replyTarget || this.listeners.forEach((function(e) {
        ...
        function bn() {
            var e = Et();
            null !== e && ("ios" === Ot() && ve(e, "9.19") >= 0 || "android" === Ot() && ve(e, "11.6.0") >= 0) ? location.href = "liff://close" : window._liff && window._liff.postMessage ? null !== e && ve(e, "10.15.0") >= 0 ? "ios" === Ot() ? window._liff.postMessage("closeWindow", "") : window._liff.postMessage("closeWindow", "", "", "") : wn("closeWindow") : window.close()
        }
        !function(e) {
            function t() {
                return null !== e && e.apply(this, arguments) || this
        ...
        function gn(e) {
            return Kt($t("subWindowGetOrigin")(e))
        }
        var yn = {};
        function In(e, t) {
        ...
        var En, Cn, On, Pn, _n, kn = function() {
            function e(e) {
                this.storage = e
            }
        ...
        function Rn() {
            return k(this, arguments, void 0, (function(e) {
                return void 0 === e && (e = nn),
                A(this, (function(t) {
                    switch (t.label) {
                    case 0:
                        return [4, (_n = new fn(e)).setup()];
                    case 1:
                        return t.sent(),
                        [2, _n]
                    }
                    ...
                    case 4:
                        ...
                        [2, new Promise((function(t) {
                            window.addEventListener("message", (function n(i) {
                                Vn(i) && (window.removeEventListener("message", n),
                                t({
                                    status: e,
                                    result: r
                                }))
            ...
            if (e.origin === n) {
                ...
                if (r) {
                    ...
                    case ue.SUBMIT:
                        xn(!0),
                        window.clearInterval(Nn()),
                        window.removeEventListener("message", Gn),
                        In(o, i),
                        null === (t = jn()) || void 0 === t || t.postMessage({
                            type: o
                        }, Un());
                        break;
                    default:
            ...
            return k(this, void 0, void 0, (function() {
                ...
                return A(this, (function(m) {
                    ...
                    case 0:
                        ...
                        m.label = 1;
                    case 1:
                        return m.trys.push([1, 3, , 5]),
                        [4, Jt($t("subWindowSubscribe"), {
                            method: "POST",
                            body: JSON.stringify({
                                msit: t,
                                mstChallenge: n
                    ...
                    case 6:
                        ...
                        [3, 17];
                    case 7:
                        return l.status >= 400 && 500 > l.status ? [4, Qn(l)] : [3, 9];
                    case 8:
                        return d = m.sent(),
                        ...
                        [3, 17];
                    case 9:
                        return 200 !== l.status ? [3, 16] : [4, Qn(l)];
                    case 10:
                        if (!(d = m.sent()))
        ...
        function er(e) {
            ...
            return function(e) {
                var t = e.mainLiffId
                  ...
                  , i = e.appData
                  , o = e.view;
                return t && r ? Kt($t("subWindowGetMSIT"), {
                    method: "POST",
                    body: JSON.stringify({
                        mainLiffId: t,
                        subLiffId: n,
            ...
            Je() ? er(e) : function(e) {
                return k(this, void 0, void 0, (function() {
                    ...
                    return A(this, (function(h) {
                        switch (h.label) {
                        case 0:
                            return (t = De(e.url)) ? (qn(!0),
                            [4, zn()]) : [2, Promise.reject(Ce(z, "params.url must be liff url or mini url"))];
                        case 1:
                            return h.sent(),
                            Fn("ios" !== Ot() || We() ? window.open("", "liffsubwindow", "width=480, height=640, menubar=no, toolbar=no, scrollbars=yes") : window.open()),
                            n = e.url,
                            r = e.appData,
                        ...
                        case 2:
                            return o = h.sent(),
                            i.searchParams.append(Qt, o.identification.identifier),
                            i.searchParams.append(Yt, o.identification.cryptoKey),
                        ...
                        case 3:
                            ...
                            o.listen(Kn),
                            o.setData("appData", r),
                            window.addEventListener("message", Gn),
                            h.label = 4;
                        case 4:
        ...
        function cr(e) {
            var t = e.msit
              , n = e.mstVerifier;
            return t && n ? Kt($t("subWindowGetMSTByMSIT"), {
                method: "POST",
                body: JSON.stringify({
                    msit: t,
                    mstVerifier: n
        ...
        function ur(e) {
            var t = e.mst;
            return t ? Kt($t("subWindowGetAppData"), {
                method: "POST",
                body: JSON.stringify({
                    mst: t
                })
        ...
        var lr, fr = {
            ...
            t.prototype.install = function() {
                ...
                return {
                    ...
                    submit: or.bind(this),
                    close: ar.bind(this),
                    getAppData: sr.bind(this)
                }
            }
        }(H),
        n(255)), hr = n.n(dr), pr = function() {
            var e = this;
            this.type = "sync",
            this.fns = new Set,
            this.on = function(t) {
            ...
            var t, n = xe(43), r = function(e) {
                ...
                window.btoa(t)
            }(hr()(n)).replace(/\+/g, "-").replace(/\//g, "_").replace(/=/g, ""), i = qe();
            if (!i || !i.liffId)
            ...
            var o = {
                ...
                code_challenge: r,
                liff_sdk_version: "2.27.1"
            };
            e && e.redirectUri && (o.redirect_uri = e.redirectUri),
            Tt() && !Je() && ((null === (t = Dn()) || void 0 === t ? void 0 : t.isReady()) ? o.redirect_uri = window.location.href : o.disable_auto_login = "true"),
            function(e) {
                $e(oe.LOGIN_TMP, e)
            }({
                codeVerifier: n
            });
            var a = $t("authorize") + "?" + Ae(o);
            ...
            ,
            t
        }(H), br = "undefined" == typeof navigator ? "en" : null !== (lr = navigator.language) && void 0 !== lr ? lr : "en", gr = null;
        function yr(e) {
            return k(this, void 0, void 0, (function() {
                return A(this, (function(t) {
                    switch (t.label) {
        ...
        function Ir() {
            return k(this, void 0, void 0, (function() {
                ...
                return A(this, (function(n) {
                    switch (n.label) {
                    case 0:
                        return [4, Kt("".concat("https://liffsdk.line-scdn.net/xlt/manifest.json").concat("?t=",Date.now()), {
                            method: "GET",
                            headers: {
                                Accept: "application/json"
                            }
                    ...
                    case 1:
                        return e = n.sent(),
                        t = "".concat(br),
                        !e.languages[t] && br.includes("-") && (t = br.split("-")[0]),
                        e.languages[t] || (t = "en"),
                        [4, Kt("".concat("https://liffsdk.line-scdn.net/xlt", "/").concat(e.languages[t]).concat("?t=",Date.now()), {
                            method: "GET",
                            headers: {
                                Accept: "application/json"
                            }
        ...
        function Or(e) {
            var t = Xe()
              ...
              , o = n.darkModeColor
              , a = r.includes("dark");
            e.matches && a ? Pr(_(_({}, Cr), o)) : Pr(_(_({}, Er), i))
        }
        function Pr(e) {
            var t = e.iconColor
              , n = e.statusBarColor
            ...
            _r("--liff-base-background-color", f),
            _r("--liff-base-text-color", d),
            _r("--liff-base-background-rgb-color", be(f)),
            _r("--liff-base-text-rgb-color", be(d)),
            _r("--liff-light-button-border-color", h),
            _r("--liff-title-text-color", r),
            _r("--liff-title-background-color", a),
            _r("--liff-title-button-color", o),
            _r("--liff-icon-color", t),
            _r("--liff-status-bar-color", n),
            _r("--liff-title-subtext-color", i),
            _r("--liff-progress-bar-color", s),
            _r("--liff-progress-background-color", c),
            _r("--liff-title-button-area-background-color", me(u)),
            _r("--liff-title-button-area-border-color", me(l))
        }
        function _r(e, t) {
            ...
            return k(this, void 0, void 0, (function() {
                ...
                return A(this, (function(n) {
                    ...
                    case 0:
                        return [4, Wt()];
                    case 1:
                        return (t = n.sent()) ? (t.install(e, kr),
                        [2]) : [2]
                    }
                }
                ))
        ...
        function Fr(e, t) {
            return k(this, void 0, void 0, (function() {
                var n, r, i, o, a, s, c, u, l, f, d, h, p, v, m, w;
        ...
        var Ur = null;
        function Rr() {
            "boolean" == typeof Ur && R.warn("liff.init is not expected to be called more than once"),
            Ur = !!Boolean(ze(oe.IS_SUBSEQUENT_LIFF_APP)) || !(!Je() || ke(window.location.hash).feature_token || ot()) && (function(e) {
        ...
        function Mr(e) {
            return Kt("".concat($t("apps"), "/").concat(e, "/featureToken"))
        }
        function Wr(e) {
            return k(this, void 0, void 0, (function() {
                var t, n, r, i;
        ...
        function Vr(e) {
            return k(this, void 0, void 0, (function() {
                var t, n, r, i, o, a, s, c, u, l, f, d, h, p, v, m, w, b, g;
                return A(this, (function(y) {
                    ...
                    case 2:
                        ...
                        window.addEventListener("pageshow", Hr),
                        bt() || i && n ? [3, 5] : Dr() ? (l = Ne(location.href, {
                            "liff.hback": "2"
                        }),
                        mr({
                            redirectUri: l
                    ...
                    case 9:
                        (m = y.sent().data) && tt(JSON.stringify(m)),
                        y.label = 10;
                    case 10:
                        return o && !st() && ct(o),
                        o && a && !vt() ? [4, Fr(o, a)] : [3, 12];
                    case 11:
                        (w = y.sent()) && mt(w),
                        y.label = 12;
                    case 12:
                            ...
                            return k(i, void 0, void 0, (function() {
                                ...
                                return A(this, (function(s) {
                                    ...
                                    case 2:
                                        ...
                                        s.label = 3;
                                    case 3:
                                        return (a = ke(location.hash).context_token) ? (Qe(jr(a)),
                                        [3, 6]) : [3, 4];
                                    case 4:
                                        return [4, Kr()];
                                    case 5:
            ...
            return k(this, void 0, void 0, (function() {
                ...
                return A(this, (function(s) {
                    ...
                    case 3:
                        ...
                        i = r.eventName,
                        o = r.data,
                        i !== Zt.NOT_FOUND ? [3, 6] : [4, e.teardown()];
                    case 4:
                        return s.sent(),
                        [4, qr()];
                    case 5:
                        ...
                        return e.listen((function(t) {
                            return k(a, void 0, void 0, (function() {
                                ...
                                return A(this, (function(o) {
                                    return r = t.context,
                                    i = r.data,
                                    r.eventName === ue.INIT && (null == i ? void 0 : i.subWindowId) !== n && bn(),
                ...
                return A(this, (function(r) {
                    ...
                    case 2:
                        if (n.error && n.liffOAuth2Error)
                            throw a = n.error,
                            s = n.error_description.replace(/\+/g, " "),
                            c = "".concat(a, ": ").concat(s),
                            Ce($, c);
                        return i = n.code,
                        o = dt(),
                        Boolean(i && !bt() && o && o.codeVerifier) ? [4, Jr(n.liffClientId)] : [3, 4];
                    case 3:
                        r.sent(),
                        r.label = 4;
                    case 4:
                        return Je() ? [4, Vr(e)] : [3, 6];
                    case 5:
                        return r.sent(),
                        [3, 8];
                    case 6:
        ...
        var Xr = function(e, t) {
          ...
          , Qr = function(e) {
            ...
            Xr(t, "LUI_ALERT_URL is not defined")
        }
          , Yr = function() {
            return k(void 0, void 0, void 0, (function() {
                var e;
                return A(this, (function(t) {
                    ...
                    case 0:
                        ...
                        e ? [3, 2] : [4, Xr("https://static.line-scdn.net/lui/edge/versions/1.13.0/luivendor.js", "LUI_VENDOR_URL is not defined")];
                    case 1:
                        t.sent(),
                        t.label = 2;
                    case 2:
                    ...
                    case 3:
                        ...
                        new Promise((function() {
                            ...
                            e.innerHTML = '<lui-alert id="'.concat("liffAlert", "-").concat(n, '" shown title="').concat(Sr("alert.android.extBrowser.autoLoginWorkaround.title"), '" message="').concat(Sr("alert.android.extBrowser.autoLoginWorkaround.desc"), '" button="').concat(Sr("alert.android.extBrowser.autoLoginWorkaround.button.text"), '"></lui-alert>'),
                            document.body.appendChild(e);
        ...
        function ei() {
            return k(this, void 0, void 0, (function() {
                ...
                return A(this, (function(r) {
                    switch (r.label) {
                    case 0:
                        return (e = null !== (n = Zr(window.location.href)) && void 0 !== n ? n : Zr(window.document.referrer)) && ve(e, "13.10.0") >= 0 || Je() || "android" !== Ot() || (t = ke(window.location.search))[Qt] || t.liffIsEscapedFromApp ? [2] : t.liffClientId && document.referrer.includes("access.".concat("line.me")) ? (window.location.href = Ne(window.location.href, {
                            liffIsEscapedFromApp: "true"
                        }),
                        [2]) : t.liffClientId && document.referrer.includes("android-app://") ? [4, Yr()] : [3, 2];
                    case 1:
                        r.sent(),
                        r.label = 2;
                    case 2:
                        return t.liffClientId && "" === document.referrer && 1 === window.history.length ? [4, Yr()] : [3, 4];
                    case 3:
                        r.sent(),
                        r.label = 4;
                    case 4:
                        return !document.referrer.includes("liffClientId") || document.referrer.includes("liffIsEscapedFromApp") ? [3, 6] : [4, Yr()];
                    case 5:
                        r.sent(),
                        r.label = 6;
                    case 6:
        ...
        var ti = function(e) {
            function t() {
                ...
                t.internalHooks = {
                    beforeFinished: new vr,
                    beforeSuccess: new vr,
                    error: new vr
                },
                t
            }
                ...
                return k(this, void 0, void 0, (function() {
                    ...
                    return A(this, (function(i) {
                        ...
                        case 2:
                            ...
                            [4, Promise.all([Ar(this.liffForWindow), $r(e, this.internalHooks.beforeFinished.call)])];
                        case 3:
                            return i.sent(),
                            function() {
                                var e;
                                ...
                                t.addEventListener ? t.addEventListener("change", Or) : t.addListener && t.addListener(Or)
                            }(),
                            [4, this.internalHooks.beforeSuccess.call()];
                        case 4:
                            return i.sent(),
                            !e.withLoginOnExternalBrowser || bt() ? [3, 6] : (mr(),
                            [4, new Promise((function() {}
                            ))]);
                        case 5:
                            i.sent(),
        ...
        function si() {
            var e = qe().liffId;
            if (e)
                return Kt("".concat($t("unauthorizedPermissions"), "?liffId=").concat(e), {
                    headers: {
                        "Content-Type": "application/json",
                        Accept: "application/json",
        ...
        var ci, ui = fr.on, li = fr.off, fi = fr.open, di = function() {
            function e(e, t) {
                var n = this;
            ...
            return e.prototype.setup = function() {
                ...
                ui("close", this.onClose),
                ui("cancel", this.onCancel),
                ui("error", this.onError)
            }
            ,
            e.prototype.teardown = function() {
                li("submit", this.onSubmit),
                li("close", this.onClose),
                li("cancel", this.onCancel),
                li("error", this.onError),
                ci = void 0
            }
            ,
            ...
            return function() {
                ...
                return k(n, void 0, void 0, (function() {
                    ...
                    return A(this, (function(a) {
                        ...
                        case 2:
                            return "prompt" !== o || !ai() || i || !Je() && "chat_message.write" === t ? [3, 4] : [4, hi()];
                        case 3:
                            return a.sent(),
                            [3, 5];
                        case 4:
        ...
        function Ii(e) {
            if (!function(e) {
                return Array.isArray(e) && e.every(gi)
            }(e))
                return yi("Parameter 'messages' must be an array of { type, ... }");
            var t = e.length;
            return t < 1 || t > 5 ? yi("Number of messages should be in range 1 to ".concat(5, ".")) : Kt($t("message"), {
                method: "POST",
                body: JSON.stringify({
                    messages: e
                })
        ...
        !function(e) {
            ...
            t.prototype.install = function() {
                return vi(Ii, "chat_message.write")
            }
        }(H);
        function Ti() {
            return Kt($t("friendship"))
        }
        !function(e) {
            function t() {
                return null !== e && e.apply(this, arguments) || this
        ...
        var Oi, Pi = function(e) {
        ...
        }, ki = /([\x90\x9D\x81\x8D\x8F<"{|}>\\^`“›„•‚ŽŠ…’—ž–‘”‡™‰ŒšŸ‹œ†¥¿©áÄýÍÎðô]|\n|.*#.*#|%(?![0-9A-Fa-f]{2})[^%]{0,2})/, Ai = function(e) {
            if (ki.test(e))
                ...
                try {
                    for (var a = L(i.entries()), s = a.next(); !s.done; s = a.next()) {
                        var c = x(s.value, 2)
                          , u = c[0]
                          , l = c[1];
                        o.push("".concat(Fi(u), "=").concat(Fi(l)))
                    }
                } catch (d) {
                    t = {
                        error: d
            ...
            if (n.username !== r.username || n.password !== r.password)
                throw Ce(z, "invalid URL.");
            if (r.origin !== n.origin || !Ui(r.pathname, n.pathname))
                throw Ce(z, "invalid URL.")
        }, Di = function(e) {
            function t() {
                var t = e.apply(this, F([], x(arguments), !1)) || this;
                ...
                t.createUrlBy = function(e) {
                    return k(t, void 0, void 0, (function() {
                        ...
                        return A(this, (function(s) {
                            ...
                            [2, o.concat(a, xi(r.pathname, i.pathname), ji(r.search, i.search), Ni(r.hash))]
                        }
                        ))
                    }
                    ))
            ...
            return e.prototype.start = function() {
                fr.on("submit", this.onSubmit),
                fr.on("close", this.onClose),
                fr.on("cancel", this.onCancel),
                fr.on("error", this.onError)
            }
            ,
            e.prototype.destroy = function() {
                fr.off("submit", this.onSubmit),
                fr.off("close", this.onClose),
                fr.off("cancel", this.onCancel),
                fr.off("error", this.onError),
                Oi = void 0
            }
            ,
            e
        ...
        var $i = function() {
            ...
            e.prototype.initAllowPostMessageOrigin = function(e) {
                return void 0 === e && (e = $t("shareTargetPicker")),
                function(e) {
                    var t = e.match(/^(https?:\/\/.*?)\//);
                    return t && t[1] || ""
                }(e)
                ...
                return k(this, void 0, void 0, (function() {
                    ...
                    return A(this, (function(r) {
                        ...
                        case 0:
                            ...
                            t = "".concat($t("shareTargetPickerOtt"), "/").concat(this.liffId, "/ott"),
                            n = this,
                            [4, Kt(t, {
                                method: "GET",
                                signal: e
            ...
            e.prototype.openAnotherWindow = function() {
                if (Je() && this.payloadToShareTargetPicker)
                    ...
                    !function(e, t, n) {
                        ...
                        e.location.href = "".concat($t("shareTargetPicker"), "?").concat(Ae(r))
                ...
                return k(this, void 0, void 0, (function() {
                    ...
                    return A(this, (function(n) {
                        ...
                        case 0:
                            ...
                            [4, Kt("".concat($t("shareTargetPickerResult"), "?").concat(Ae(t)), {
                                method: "POST",
                                signal: e,
                                headers: {
                                    Accept: "application/json",
            ...
            e.prototype.getShareResult = function() {
                return k(this, void 0, void 0, (function() {
                    ...
                    return A(this, (function(n) {
                        ...
                        [2, Kt("".concat($t("shareTargetPickerResult"), "?").concat(Ae(t)), {
                            method: "GET",
                            headers: {
                                Accept: "application/json"
                            },
                    ...
                    return k(t, F([e], x(n), !1), void 0, (function(e, t) {
                        ...
                        A(this, (function(u) {
                            ...
                            case 0:
                                ...
                                if (!(n = qe().liffId))
                                    throw Ce(Q);
                                window.liff && (r = window.liff).analytics && _i(r.analytics),
        ...
        function Yi(e, t) {
            return k(this, void 0, void 0, (function() {
                ...
                return A(this, (function(i) {
                    switch (i.label) {
                    case 0:
                        return n = $t("createShortcutOnHomeScreen"),
        ...
        function ro(e) {
            ...
            if (!Me(e.url)) {
                ...
                n.liffId !== De(e.url) && Ri(e.url, n.endpointUrl)
            }
        }
        function io(e) {
            return k(this, void 0, void 0, (function() {
        ...
        function so(e) {
            return k(this, arguments, void 0, (function(e) {
                ...
                return A(this, (function(e) {
                    switch (e.label) {
                    case 0:
                        return [4, wn("iap.getPlatformProducts", {
                            productIds: t
                        }).catch((function(e) {
        ...
        var co = function(e) {
                            ...
                            return A(this, (function(e) {
                                ...
                                [2, k(void 0, void 0, void 0, (function() {
                                    return A(this, (function(e) {
                                        switch (e.label) {
                                        case 0:
                                            return [4, wn("iap.requestConsentAgreement").catch((function(e) {
                                                if (e.code && e.description)
                                                    throw Ce(e.code, e.description);
          ...
          , lo = Object.defineProperties({}, {
            ...
            sendMessages: {
                value: vi(Ii, "chat_message.write"),
                enumerable: !0,
                writable: !0
            },
            subWindow: {
        ...
        [new G(fo,ho), new wr, new ti, new Pi, Hi, Bi, St, mi, Qi, Tr, new Mt, new oo, new ao, new uo].forEach((function(e) {
            po.call(lo, e)
        }
        ));
        const vo = lo
